...
{
    public class GrassPlatform : Sprite
    {
        public GrassPlatform(Texture2D image, Vector2 position, Vector2 screen)
            : base(image, position)
        {
            myPosition = position;
            myScreenSize = screen;
        ...
        public GrassPlatform Clone()
        {
            return new GrassPlatform(this.myTexture, this.myPosition, this.myScreenSize);
        }
